    ...
    <div>
      ...
      <main className="min-h-screen">
        ...
        <section className="flex flex-col items-center justify-center text-center py-20 bg-gradient-to-r from-gray-900 to-gray-400  px-6 md:px-0">
          <h2 className="text-4xl md:text-5xl font-bold text-white">Pratice For Your Next Interview</h2>
          <p className="mt-4 text-lg md:text-xl text-white ">Practice with AI-powered mock interviewer and get personalized feedback</p>
          <div className="mt-6 flex flex-col md:flex-row">
            ...
            <a
              href="#features"
              className="px-6 py-3 text-lg font-semibold border border-white rounded-lg hover:bg-white hover:text-black-600 hover:text-xl"
            >
              Learn More
            </a>
          </div>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-gray-400 rounded-lg p-6 shadow-md">
                  ...
                  <p className="mt-2 text-white">Experience realistic interview scenarios with our advanced AI.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-gray-400 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">Instant Feedback</h3>
                  <p className="mt-2 text-white">Get instant, personalized feedback to improve your performance.</p>
                </div>
              </div>
              <div className="w-full md:w-1/3 px-4 py-8">
                <div className="bg-gray-400 rounded-lg p-6 shadow-md">
                  <h3 className="text-2xl font-semibold text-black-600">Comprehensive Reports</h3>
                  <p className="mt-2 text-white">Receive detailed reports highlighting your strengths and weaknesses.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-slate-200 rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-black-600">- Priyanshu Verma</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-slate-200 rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-black-600">- Shubham Kumar</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="py-8 bg-black text-white text-center">
        <p>© 2024 AI Interviewer. Made with ❤️ by Parth Dwivedi. All rights reserved.</p>
      </footer>
    </div>
  )
}
